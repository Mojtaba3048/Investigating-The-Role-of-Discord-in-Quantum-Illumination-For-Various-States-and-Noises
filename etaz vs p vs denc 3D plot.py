...
discords = np.zeros(len(df))           
pas = np.zeros(len(discords))           
etazss = np.zeros(len(discords))           
...
ax.plot_trisurf(etazss , pas , discords , edgecolor='red' , alpha = 0.2)
ax.set(xlabel='Etaz', ylabel='P', zlabel='denc')
